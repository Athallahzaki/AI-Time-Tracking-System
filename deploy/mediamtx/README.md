...
```powershell
Copy-Item deploy/mediamtx/.env.mediamtx.example deploy/mediamtx/.env.mediamtx
notepad deploy/mediamtx/.env.mediamtx
./deploy/mediamtx/start-mediamtx.ps1
```

Linux/macOS:

```bash
cp deploy/mediamtx/.env.mediamtx.example deploy/mediamtx/.env.mediamtx
# edit CAM01_SOURCE dan MEDIAMTX_WEBRTC_ADDITIONAL_HOSTS
sh deploy/mediamtx/start-mediamtx.sh
```
...
1. `./deploy/mediamtx/start-mediamtx.ps1` atau `sh deploy/mediamtx/start-mediamtx.sh`
...
docker compose --env-file deploy/mediamtx/.env.mediamtx -f deploy/mediamtx/docker-compose.mediamtx.yml logs -f
```
...
```bash
docker compose --env-file deploy/mediamtx/.env.mediamtx -f deploy/mediamtx/docker-compose.mediamtx.yml down
```
